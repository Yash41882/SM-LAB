// Problem - Calculation of central values for lists(mean,median,mode,variance,standard deviation, coefficient of correlation)

Nums1 = grand(1,100,"uin",10,100);

disp("Mean of Random Numbers", mean(Nums1))
disp("Median of Random Numbers", median(Nums1))
disp("Mode of Random Numbers",mode(Nums1))
